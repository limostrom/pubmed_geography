...
local countries zzz "Afghanistan" "Algeria" "Andorra" "Angola" "Argentina" "Buenos Aires"
			...
			"France" "French Guiana" "Guadeloupe" "New Caledonia" 
				"Angers" "Beaujon" "Bordeaux" "Boulogne" "Dijon" "Lille" "Limoges" "Lyon" "Marseille" "Nantes" 
				"Nice" "Nogent" "Paris" "Rouen" "Strasbourg" "Toulouse" "Villejuif" "Vitry Sur Seine"
			...
			"Netherland" "Amsterdam" "Breda" "Leiden" "Nijmegen" "Rijswijk" "Rotterdam" "New Zealand" "Auckland" 
			...
			"Spain" "EspaÃ±a" "Barcelona" "CÃ³rdoba" "Jaen" "Madrid" "Navarra" "Pamplona" "Santander" "Sevill"
			...
			"Uzbekistan" "Venezuela" "Caracas" "Viet Nam" "Vietnam" "Veitnam" "West Indies" "Wales" "Cardiff"
